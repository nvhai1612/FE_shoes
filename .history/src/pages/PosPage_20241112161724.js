  ...
  return (
    <Container>
      ...
      <Modal show={showModal} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          {/* Nội dung Modal, có thể bao gồm form hoặc thông tin khác */}
          <p>Bạn có muốn thêm sản phẩm này vào đơn hàng không?</p>
        </Modal.Body>
        <Modal.Footer>
          <Button variant="secondary" onClick={handleCloseModal}>
            Hủy
          </Button>
          <Button variant="primary" onClick={handleConfirmAddProduct}>
            Xác nhận
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      <div className="p-3 mt-4 border-top">{/* Các phần nội dung khác */}</div>
      <ToastContainer />
    </Container>
  );
}
