      ...
      <Modal show={show} onHide={handleClose} size="lg">
        ...
        <Modal.Body>
          ...
          <Table bordered hover>
            ...
            <tbody>
              {/* Ví dụ một hàng sản phẩm */}
              <tr>
                <td>
                  <img src="shoe_image.jpg" alt="product" width="50" />
                </td>
                <td>Balenciaga Grey 2023</td>
                <td>PD12</td>
                <td>Đế nhựa</td>
                <td>Giày lười</td>
                <td>Balenciaga</td>
                ...
                <td>
                  <div>
                    ...
                    <br />
                    <span style={{ color: "green" }}>137.500 VND</span>
                  </div>
                </td>
                <td>
