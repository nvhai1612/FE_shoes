    ...
    <Container>
      ...
      <div className="p-3 mt-4 border-top">
        ...
        <Button
          ...
          style={{
            width: "100%",
            backgroundColor: "#B30D1B",
            color: "#fff",
            borderColor: "#B30D1B",
            height: "40px",
          }}
        >
          <FaCreditCard style={{ marginRight: "10px" }} /> Thanh toán
        </Button>
      </div>
      ...
      <Modal show={showAddProductModal} onHide={handleCloseModal} centered>
        ...
        <Modal.Body>
          <InputGroup>
            <Form.Control placeholder="Nhập mã sản phẩm" />
          ...
          <Table striped bordered hover size="sm" className="mt-3">
            ...
            <tbody>
              {/* Sử dụng map() để hiển thị danh sách sản phẩm từ state hoặc props */}
            </tbody>
          </Table>
        </Modal.Body>
        <Modal.Footer>
