  ...
  return (
    <Container>
      ...
      <Modal
        ...
        size="lg" // Giữ lại kích thước lớn (lg) cho modal
        centered
        style={{
          maxWidth: "800px", // Điều chỉnh chiều rộng tối đa của modal
          width: "100%", // Đảm bảo modal chiếm 100% chiều rộng cho phù hợp với màn hình
        }}
      >
        ...
        <Modal.Body
          style={{
            padding: "20px", // Tùy chỉnh padding của modal body
          }}
        >
