...
function PosPage() {
  ...
  const [showConfirmModal, setShowConfirmModal] = useState(false); // Modal xác nhận thêm sản phẩm
  ...
  const handleProductSelection = (product) => {
    ...
    setShowAddProductModal(false); // Đóng modal chọn sản phẩm
    ...
    <Container>
      ...
      <Modal show={showConfirmModal} onHide={handleCloseModal}>
        <Modal.Header closeButton>
          <Modal.Title>Chọn sản phẩm để thêm vào hoá đơn</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <ul>
