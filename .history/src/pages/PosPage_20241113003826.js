...
import { FaTimesCircle } from "react-icons/fa"; // Loại bỏ FaCreditCard vì không sử dụng
...
function PosPage() {
  ...
  const [showConfirmationModal, setShowConfirmationModal] = useState(false); // Trạng thái cho modal thông báo
  const [selectedProduct, setSelectedProduct] = useState(null); // Trạng thái lưu sản phẩm được chọn
  ...
  const handleProductSelection = (product) => {
    ...
    setShowAddProductModal(false); // Đóng modal khi chọn sản phẩm
  };
  ...
  return (
    <Container>
      ...
      {/* Modal hiển thị thông báo khi thêm sản phẩm vào hoá đơn */}
      <Modal
      ...
      >
        ...
        <Modal.Body>
          <p>Sản phẩm đã được thêm vào hoá đơn!</p>
        </Modal.Body>
        <Modal.Footer>
          <Button
            variant="secondary"
      ...
      {/* Modal hiển thị danh sách sản phẩm để chọn */}
      <ProductSelection
