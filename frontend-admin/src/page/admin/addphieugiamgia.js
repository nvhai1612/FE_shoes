            ...
            <div class="col-sm-12">
                <form onSubmit={handleAddPhieuGG} class="form-add row">
                    <div class="col-sm-5">
                        ...
                        <input name='maCode' defaultValue={item?.maCode} class="form-control"/>
                    ...
                    <div className='col-sm-5'>
                        ...
                        <input name='soLuong' defaultValue={item?.soLuong} class="form-control"/>

                        <label class="lb-form">Ngày bắt đầu</label>
                        <input name='ngayBatDau' defaultValue={item?.ngayBatDau} type='datetime-local' class="form-control"/>

                        <label class="lb-form">Ngày kết thúc</label>
                        <input name='ngayKetThuc' defaultValue={item?.ngayKetThuc} type='datetime-local' class="form-control"/>
