...
const AdminDeGiay = ()=>{
    ...
    async function saveData(event) {
        ...
        const payload = {
            tenDeGiay: event.target.elements.catename.value,
    ...
    return (
        ...
        <div class="modal fade" id="addcate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="false">
            ...
            <div class="modal-content">
                <div class="modal-header"><h5 class="modal-title" id="exampleModalLabel">Thêm hoặc cập nhật đế giày</h5> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div>
                <div class="modal-body">
                    <form class="col-sm-5 marginauto" onSubmit={saveData} method='post'>
                        <label>Tên</label>
                        <input defaultValue={item?.tenDeGiay} name="catename" id='catename' type="text" class="form-control" />
                        <br/><br/>
