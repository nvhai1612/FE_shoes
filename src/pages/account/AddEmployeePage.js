...
function AddEmployeePage({ onBack }) {
  ...
  return (
    <Container style={{ marginTop: '-20px', paddingTop: '0' }}> {/* Điều chỉnh khoảng cách để sát header */}
      <h2 style={{ textAlign: 'center', fontSize: '28px', fontWeight: 'bold', marginTop: '0' }}>Thêm nhân viên</h2>
      ...
      <Form>
        <Row>
          ...
          <Col md={6}>
            ...
            <div
              style={{
                ...
                border: '1px dashed #ccc', borderRadius: '50%', width: '150px', height: '150px',
                margin: '43px auto', fontSize: '14px', color: '#999',
            ...
            <Form.Group controlId="employeeName" style={{ marginBottom: '10px' }}>
              <Form.Label>Họ và Tên</Form.Label>
              <Form.Control type="text" placeholder="Nhập họ và tên" />
            </Form.Group>

            <Form.Group controlId="employeePhone" style={{ marginBottom: '10px' }}>
          ...
          <Col md={6}>
            ...
            <Form.Group controlId="employeeGender" style={{ marginBottom: '10px' }}>
            ...
            <Form.Group controlId="employeeDOB" style={{ marginBottom: '10px' }}>
              <Form.Label>Ngày sinh</Form.Label>
              <Form.Control type="date" />
            </Form.Group>

            <Form.Group controlId="employeeEmail" style={{ marginBottom: '10px' }}>
              <Form.Label>Email</Form.Label>
              <Form.Control type="email" placeholder="Nhập email" />
            </Form.Group>
            <Form.Group controlId="employeeAddress" style={{ marginBottom: '10px' }}>
