...
function SizeList() {
  ...
  useEffect(() => {
    ...
    const data = [
      { id: 1, name: "S", createdAt: "01/06/2024", status: "Đang bán" },
      { id: 2, name: "M", createdAt: "15/07/2024", status: "Đang bán" },
    ];
    setSizes(data);
  }, []);
  ...
  const handleSaveChanges = () => {
    setSizes(
      sizes.map((size) => (size.id === editingSize.id ? editingSize : size))
    );
              ...
              <Form.Group controlId="sizeStatus" className="mt-3">
                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  <Form.Check
                    ...
                    onChange={() =>
                      setEditingSize({ ...editingSize, status: "Đang bán" })
                    }
                  />
                  <Form.Check
                    type="radio"
                    ...
                    onChange={() =>
                      setEditingSize({ ...editingSize, status: "Ngừng bán" })
                    }
                  />
                </div>
              </Form.Group>
      ...
      <Modal show={showAddModal} onHide={() => setShowAddModal(false)}>
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group controlId="newSizeStatus" className="mt-3">
              <Form.Label>Trạng thái</Form.Label>
              <div style={{ display: "flex", gap: "10px" }}>
                <Form.Check
                  type="radio"
